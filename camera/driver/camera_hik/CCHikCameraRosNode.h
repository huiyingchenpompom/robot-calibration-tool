 ...
 *
 */
#ifndef CC_HIK_CAMERA_ROSNODE_H
#define CC_HIK_CAMERA_ROSNODE_H
...
class CCHikCameraRosNode : public utility::CCMessageNode
{
public:
    explicit CCHikCameraRosNode(const std::string &, int transmitType);
...
template<typename CallbackT>
void CCHikCameraRosNode::createSubscribeGetImage(  const std::string& topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
...
template<typename CallbackT>
void CCHikCameraRosNode::createSubscribeSetParam( const std::string &topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
