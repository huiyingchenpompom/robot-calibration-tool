 ...
 *
 */
#ifndef CC_OPT_CAMERA_ROSNODE_H
#define CC_OPT_CAMERA_ROSNODE_H
...
class CCOptCameraRosNode : public utility::CCMessageNode
{
public:
    explicit CCOptCameraRosNode(const std::string &, int transmitType);
...
template<typename CallbackT>
void CCOptCameraRosNode::createSubscribeGetImage(  const std::string& topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
...
template<typename CallbackT>
void CCOptCameraRosNode::createSubscribeSetParam( const std::string &topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
