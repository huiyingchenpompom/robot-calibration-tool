 ...
 *
 */
#ifndef _CC_DAHENG_CAMERA_ROSNODE_H
#define _CC_DAHENG_CAMERA_ROSNODE_H
...
class CCDahengCameraRosNode : public utility::CCMessageNode
{
public:
    explicit CCDahengCameraRosNode(const std::string &, int transmitType);
...
template<typename CallbackT>
void CCDahengCameraRosNode::createSubscribeGetImage(  const std::string& topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
...
template<typename CallbackT>
void CCDahengCameraRosNode::createSubscribeSetParam( const std::string &topic
                                                     , CallbackT && callback
                                                     , uint32_t queueSize)
{
...
#endif // _CC_DAHENG_GIGE_CAMERA_ROSNODE_H
