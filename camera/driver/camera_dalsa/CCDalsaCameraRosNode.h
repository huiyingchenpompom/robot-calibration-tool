 ...
 *
 */
#ifndef CC_DALSA_CAMERA_ROSNODE_H
#define CC_DALSA_CAMERA_ROSNODE_H
...
class CCDalsaCameraRosNode : public utility::CCMessageNode
{
public:
    explicit CCDalsaCameraRosNode(const std::string &, int transmitType);
...
template<typename CallbackT>
void CCDalsaCameraRosNode::createSubscribeGetImage(  const std::string& topic
                                                   , CallbackT && callback
                                                   , uint32_t queueSize)
{
...
template<typename CallbackT>
void CCDalsaCameraRosNode::createSubscribeSetParam( const std::string &topic
                                                   , CallbackT && callback
                                                   , uint32_t queueSize)
{
...
#endif // CC_DALSA_CAMERA_ROSNODE_H
